...
val slinkySettings = Seq(
  npmDependencies in Compile += "react" -> "16.11.0",
  npmDependencies in Compile += "react-dom" -> "16.11.0",
...
val client = project.settings(slinkySettings).enablePlugins(ScalaJSBundlerPlugin, ScalaJSPlugin)
